...
$(document).ready(function () {
    ...
    diffBrowserCompactCommitSelectable = function () {
        ...
        return $("#merge_request_commit_selector.compact").selectable({
            filter: "li.single_commit",

            stop: function (e, ui) {
                var sha_spec = new Gitorious.ShaSpec();
                $("li.ui-selected a", this).each(function () {
                    var sha = $(this).attr("data-commit-sha");
                    sha_spec.addSha(sha);
                });
    ...
    $("#current_shas").each(function () {
        var sha_spec = $(this).attr("data-merge-request-current-shas");
