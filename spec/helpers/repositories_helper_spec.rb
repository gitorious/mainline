...
describe RepositoriesHelper do
  ...
  #   helper.log_path("master").should == project_repository_commits_path(@project, @repository, ["master"])
  # end
  #
  # it "has a log_path shortcut that takes args" do
  #   helper.log_path("master", :page => 2).should == project_repository_commits_path(@project, 
